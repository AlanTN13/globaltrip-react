                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.15fr_0.7fr_0.9fr_1fr] mb-20">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            {/* WhatsApp */}
                            <a href="https://api.whatsapp.com/send/?phone=5491131411755&text=Hola%21+vengo+de+la+web+y+me+gustar%C3%ADa+realizar+una+consulta.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#25D366] hover:border-[#25D366] transition-colors">
