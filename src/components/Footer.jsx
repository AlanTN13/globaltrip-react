                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.15fr_0.7fr_0.9fr_1fr] mb-20">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            {/* WhatsApp */}
                            <a href="https://api.whatsapp.com/send/?phone=59899123456&text=Hola%21+vengo+de+la+web+y+me+gustar%C3%ADa+realizar+una+consulta.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#25D366] hover:border-[#25D366] transition-colors">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <nav className="flex flex-col gap-4">
                            ...
                            <Link to="/noticias" className="text-slate-500 text-[14px] font-semibold hover:text-primary">Noticias</Link>
                    ...
                    {/* Quick Contact */}
                    <div className="flex flex-col gap-6">
                        <h4 className="text-[12px] font-black text-slate-900 tracking-widest uppercase">Contacto Rápido</h4>
                        <div className="flex flex-col gap-4">
                            <a href="mailto:info@globaltriplog.com" className="text-slate-500 text-[14px] font-semibold hover:text-primary transition-colors">
                                info@globaltriplog.com
                            </a>
                            <a href="https://wa.me/5491131411755" target="_blank" rel="noopener noreferrer" className="text-slate-500 text-[14px] font-semibold hover:text-primary transition-colors">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <form className="relative" onSubmit={(e) => e.preventDefault()}>
                            ...
                            />
                            <button className="absolute right-1 top-1 w-10 h-10 bg-[#0b0c49] text-white rounded-lg flex items-center justify-center hover:bg-[#161865] transition-colors">
