            ...
            {isOpen && (
                <div className="mb-2 w-72 md:w-80 overflow-hidden rounded-3xl bg-white shadow-2xl animate-fade-in-up border border-slate-100">
                    ...
                    <div className="p-6 bg-slate-50 space-y-4">
                        <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 animate-fade-in-up">
                            <p className="text-sm text-slate-800">
                                {t('whatsapp.welcome')} <span className="font-black text-[#25D366]">{t('whatsapp.company')}</span>
                            </p>
                        </div>
                        <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 animate-fade-in-up delay-100">
